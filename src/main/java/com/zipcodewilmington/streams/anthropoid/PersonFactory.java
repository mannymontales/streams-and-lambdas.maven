...
public final class PersonFactory {
    ...
    public List<Person> createPersonList(int listSize) {
        ...
        //https://www.geeksforgeeks.org/10-ways-to-create-a-stream-in-java/ number #7 generate()
//        List<Person> personStream = new ArrayList<>();
//        personStream = Stream.generate(this::createRandomPerson).limit(listSize).collect(Collectors.toList());
//        Stream.generate(this::createRandomPerson).limit(listSize).collect(Collectors.toList());
